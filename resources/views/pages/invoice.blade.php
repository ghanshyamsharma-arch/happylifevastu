...
<body>
    ...
    <div class="container">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if($item->productImage)
                                <img src="{{ url($item->productImage) }}" alt="Product Image">
                            @else
                                <span>N/A</span>
                            @endif
                        </td>
                        <td class="text-center">{{ $item->quantity ?? 1 }}</td>
                        <td class="text-center">{{ $currencySymbol->value }}{{ number_format($item->unitPrice ?? 0, 2) }}</td>
                        <td class="text-center">{{ $currencySymbol->value }}{{ number_format($item->totalPrice ?? 0, 2) }}</td>
                    </tr>
                    @empty
                    <tr>
        ...
        <div style="margin-top: 20px; margin-bottom: 20px;">
            <p><strong>Order Status:</strong> <span style="color: #666;">{{ $order->orderStatus }}</span></p>
        </div>
