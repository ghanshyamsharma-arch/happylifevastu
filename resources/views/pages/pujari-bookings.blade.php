                        ...
                        <div class="flex items-center gap-2">
                            <div class="w-8 h-8 image-fit zoom-in flex-none">
                                <img class="rounded-full"
                                     src="{{ $booking->profileImage ? (Str::startsWith($booking->profileImage,'http') ? $booking->profileImage : str_replace('storage/','public/storage/',asset($booking->profileImage))) : '/build/assets/images/person.png' }}"
...
document.addEventListener('change', function (e) {
    ...
    fetch('{{ route("updatePujariBookingStatus") }}', {
...
document.addEventListener('click', function (e) {
    ...
    .then((result) => {
        ...
        fetch('{{ route("deletePujariBooking") }}', {
