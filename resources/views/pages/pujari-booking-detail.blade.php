            ...
            <div class="intro-y box p-5 mb-5">
                <div class="text-center pb-4 border-b border-slate-200 mb-4">
                    <div class="w-16 h-16 rounded-full overflow-hidden mx-auto mb-2 image-fit">
                        <img src="{{ $booking->profileImage ? (Str::startsWith($booking->profileImage,'http') ? $booking->profileImage : str_replace('storage/','public/storage/',asset($booking->profileImage))) : '/build/assets/images/person.png' }}"
