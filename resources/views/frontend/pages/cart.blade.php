                ...
                <div class="col-md-12 d-flex align-items-center">
                    <span style="text-transform: capitalize;">
                        <span class="breadcrumbs">
                            ...
                            <a href="{{ route('front.getproducts') }}" style="text-decoration:none">Products</a>
                            <i class="fa fa-chevron-right"></i>
    ...
    <div class="container py-4">
        ...
        @if($cartItems->isEmpty())
            <div class="empty-cart">
                ...
                <a href="{{ route('front.getproducts') }}" class="shop-now-btn">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8 col-12 cart-main-content">
                <div class="cart-card">
                        ...
                        <table class="cart-table">
                            ...
                            <tr id="cart-row-{{ $item->productId }}">
                                ...
                                <td data-label="Price" class="cart-price">
                                    {{ $currency->value ?? '₹' }}{{ number_format($item->product->amount, 2) }}
                                </td>
                                ...
                                <td data-label="Total" class="cart-total" id="item-total-{{ $item->productId }}">
                                    {{ $currency->value ?? '₹' }}{{ number_format($item->product->amount * $item->quantity, 2) }}
                                </td>
                                <td data-label="">
                    ...
                    <div class="pb-3 px-3">
                        <a href="{{ route('front.getproducts') }}" class="continue-shopping">
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-content">
                        <div class="summary-row">
                            <span class="summary-label">Subtotal ({{ $cartItems->count() }} item{{ $cartItems->count() > 1 ? 's' : '' }})</span>
                            <span class="summary-value" id="summary-subtotal">
                                {{ $currency->value ?? '₹' }}{{ number_format($subtotal, 2) }}
                            </span>
                        </div>
                        @if($gstPercent > 0)
                        <div class="summary-row">
                            <span class="summary-label">GST ({{ $gstPercent }}%)</span>
                        ...
                        <div class="summary-row summary-total">
                            ...
                            <span class="summary-value" id="summary-total">
                                {{ $currency->value ?? '₹' }}{{ number_format($total, 2) }}
                            </span>
                        </div>
                        <a href="{{ route('front.checkout', $cartItems->first()->productId) }}" class="checkout-btn">
