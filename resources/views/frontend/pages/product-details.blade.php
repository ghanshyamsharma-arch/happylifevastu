...
<div class="product-details-section container pt-5 pb-5">
    <div class="row align-items-center">
        ...
        <div class="col-md-6">
            <div class="product-details-img">
                <img class="img-fluid w-100 rounded" 
                    src="{{ Str::startsWith($getproductdetails->productImage, ['http://','https://']) ? $getproductdetails->productImage : '/' . $getproductdetails->productImage }}" 
                    onerror="this.onerror=null;this.src='/build/assets/images/person.png';" 
                    alt="{{ $getproductdetails->name }}" 
                    onclick="openImage('{{ $getproductdetails->productImage }}')" />
            </div>
        </div>
        ...
        <div class="col-md-6 d-flex align-items-center p-3">
            <div class="w-100">
                <div class="mb-4">
                    <p class="product-category mb-2">✦ {{ $getproductdetails->productCategory }} ✦</p>
                    <h2 class="product-title">{{ $getproductdetails->name }}</h2>
                    <div class="gold-line"></div>
                </div>
                <div class="mb-4">
                    <span class="product-price">
                        @if($walletType == 'coin')
                            <img src="{{ asset($coinIcon) }}" alt="Wallet Icon">
                        @else
                            {{ $currency['value'] }}
                        @endif
                ...
                <div class="product-actions d-flex align-items-center gap-3 mt-4 flex-wrap">
                    ...
                    <button class="btn btn-add-cart flex-grow-1" style="margin-right:2px;"
                        data-product-id="{{ $getproductdetails->id }}"
                        data-product-name="{{ $getproductdetails->name }}">
                        <i class="fas fa-cart-plus me-1"></i> Add to Cart
                    </button>
                    <a href="{{ route('front.cart') }}" class="btn btn-outline-secondary">View Cart</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row pt-4 product-details-content">
        <div class="col">
            ...
            <div class="gold-line"></div>
            <p>{{ $getproductdetails->features }}</p>
        </div>
    </div>
