        ...
        <div class="container">
            ...
            <div class="container mt-4 mb-5 pujalist-show">
                @foreach ($pujalists as $puja)
                    ...
                    ?>
                    <div class="scard">
                        <img class="imgb" src="{{ Str::startsWith($firstImage, ['http://','https://']) ? $firstImage : '/' . $firstImage }}" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="{{ $puja->puja_title }}" onclick="openImage('{{ $firstImage }}')" />
                        ...
                        <div class="descrb">
                            <h3>{{ \Illuminate\Support\Str::limit($puja->puja_title, 58, '...') }}</h3>
                            <span>{{ \Illuminate\Support\Str::limit($puja->puja_subtitle, 58, '...') }}</span>
                        </div>
                        
                        <div class="location-info">
                            <i class="fa-solid fa-place-of-worship"></i>
                            <span>{{ \Illuminate\Support\Str::limit($puja->puja_place, 60, '...') }}</span>
                        </div>
                        ...
                        <div class="puja-footer">
                            <a href="{{ route('front.pujaDetails', $puja->slug) }}" class="read">
