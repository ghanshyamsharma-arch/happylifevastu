            ...
            <div class="banner-slider-container">
                ...
                <div class="banner-slider" id="bannerSlider">
                    @if(isset($heroBanners) && count($heroBanners) > 0)
                        ...
                        @foreach($heroBanners as $index => $bannerItem)
                            <div class="banner-slide">
                                <a href="{{ $bannerItem->redirectUrl ?? '#' }}" 
                                   @if(empty($bannerItem->redirectUrl)) onclick="return false;" @endif>
                                    <img src="{{ Str::startsWith($bannerItem->bannerImage, ['http://','https://']) 
                                        ? $bannerItem->bannerImage 
                                        : asset($bannerItem->bannerImage) }}" 
                                         alt="{{ $bannerItem->altText ?? 'Banner ' . ($index + 1) }}"
                                         loading="lazy">
                                </a>
                            </div>
                        @endforeach
                    @else
                        ...
                        <div class="banner-slide">
                            <a href="{{ route('front.getkundali') }}">
                                <img src="{{ asset('public/frontend/homeimage/banner-1.png') }}" alt="Kundli Analysis">
                            </a>
                        </div>
                        <div class="banner-slide">
                            <a href="{{ route('front.talkList') }}">
                                <img src="{{ asset('public/frontend/homeimage/banner-2.png') }}" alt="Talk to Astrologer">
                            </a>
                        </div>
                        <div class="banner-slide">
                            <a href="{{ route('front.pujaCategory') }}">
                                <img src="{{ asset('public/frontend/homeimage/banner-3.png') }}" alt="Book Puja">
                            </a>
                        </div>
                        <div class="banner-slide">
                            <a href="{{ route('front.getproducts') }}">
                                <img src="{{ asset('public/frontend/homeimage/banner-4.png') }}" alt="Astro Shop">
                            </a>
                        </div>
                    @endif
                </div>
            ...
            <div class="astro-shop-header">
                <div>
                    ...
                    <h2 class="section-title">
                        ...
                        <span>by {{ ucfirst($appname) }}</span>
                    </h2>
                    <div class="gold-divider"></div>
                </div>
                <a href="{{ route('front.getproducts') }}" class="see-all-btn">
            ...
            <div class="astro-products-grid">
                ...
                <div class="astro-product-card">
                    ...
                    <div class="card-img-wrap">
                        <img
                            src="{{ Str::startsWith($product->productImage, ['http://','https://']) ? $product->productImage : '/' . $product->productImage }}"
                            onerror="this.onerror=null;this.src='/build/assets/images/person.png';"
                            alt="{{ $product->name }}"
                            onclick="openImage('{{ $product->productImage }}')"
                        />
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('front.getproductDetails', ['slug' => $product->slug]) }}" class="buy-btn">
                                Buy Now
                            </a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row pb-2">
                <div class="col-sm-12">
                    ...
                    <h2 class="sec-t heading" data-aos="fade-left">OUR {{ucfirst($professionTitle)}}S</h2>
                    <p class="text-md-center mb-1" style="text-align: left !important;">Get in touch with the best Online {{ucfirst($professionTitle)}}s, anytime &amp;
                        anywhere!</p>
                </div>
            </div>
            <div class="row pt-3">
                               ...
                               data-target="#videoModal">
                                <div class="avideo-card position-relative">
                                    <img class="avideo-thumbnail img-fluid" 
                                         ...
                                         src="{{ Str::startsWith($video->coverImage, ['http://','https://']) ? $video->coverImage : '/' . $video->coverImage }}" 
                                         onerror="this.onerror=null;this.src='/build/assets/images/person.png';" 
                                         alt="Video thumbnail for {{ $video->videoTitle }}" />
        
                                    <img style="cursor: pointer;" class="position-absolute youtube-icon"
                                        src="{{ asset('public/frontend/homeimage/youtube.svg') }}" 
                                        alt="Play YouTube video">
                                    <div class="avideo-title text-center mt-2">{{ $video->videoTitle }}</div>
                                </div>
                            </a>
                        @endforeach
            ...
            @foreach ($astrotalkInNews as $news)
                <div class="item">
                    <div class="news-card">
                        ...
                        <img 
                            style="height:160px; width:100%; object-fit:cover;" 
                            alt="{{ $news->channel }} news coverage" 
                            class="news-thumbnail" 
                            src="{{ Str::startsWith($news->bannerImage, ['http://','https://']) ? $news->bannerImage : '/' . $news->bannerImage }}" 
                            onerror="this.onerror=null;this.src='/build/assets/images/person.png';" 
                        />
                        <div class="news-channel">
                            <span style="color: var(--gold);">✦</span> {{ $news->channel }} <span style="color: var(--gold);">✦</span>
                        </div>
                        <a href="{{ route('news.show', $news->id) }}" class="news-btn" style="margin-top: 7%;">
                            View Story →
                        </a>
                    </div>
                </div>
    ...
    <section class="blog-section bg-white">
        <div class="container">
            <div class="blog-header">
                ...
                <a href="{{ route('front.getBlog') }}" class="button-blog">See All Articles →</a>
            </div>
            
            <div class="row justify-content-start">
                @foreach ($blog as $key => $bloglist)
                <div class="col-md-4 mt-4 d-flex">
                    <a href="{{ route('front.getBlogDetails', ['slug' => $bloglist->slug]) }}" class="text-decoration-none w-100">
                        <div class="blog-card">
                            <div class="blog-card-top"></div>
                            <div class="blog-image-container position-relative">
                                <img class="blog-image" 
                                     src="{{ Str::startsWith($bloglist->blogImage, ['http://','https://']) ? $bloglist->blogImage : '/' . $bloglist->blogImage }}" 
                                     onerror="this.onerror=null;this.src='/build/assets/images/person.png';" 
                                     alt="{{ $bloglist->title }}">
                                <span class="blog-badge">✦ Article</span>
                            </div>
                            <div class="blog-body">
                                <h3 class="blog-title">{{ $bloglist->title }}</h3>
                                <p class="blog-excerpt">
                                    {!! \Illuminate\Support\Str::words($bloglist->description, 18) !!}
                                </p>
...
<script>
    (function() {
        ...
        if (demoKundaliLink) demoKundaliLink.href = "javascript:void(0);"; // just demo, but you can replace with {{ route('front.getkundali') }}
