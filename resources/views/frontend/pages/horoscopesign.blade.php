        ...
        <div class="container">
            <div class="row py-3">
                <div class="col-12 col-md-12 mt-4 cat-pages-hide">
                    ...
                    <div class="row pt-4">
    @if(isset($gethoroscopesign['recordList']) && is_array($gethoroscopesign['recordList']) && count($gethoroscopesign['recordList']) > 0)
                       ...
                       title="{{ $horoscopesign['name'] ?? '' }}" class="text-decoration-none text-dark">
                        <div>
                            ...
                            <img style="height: 110px;width:110px" 
                                 ...
                                 alt="{{ $horoscopesign['name'] ?? 'Horoscope Sign' }}" />
                        </div>
                        <div class="">
                            <p class="font-weight-bold mb-0 mt-2 color-red">{{ $horoscopesign['name'] ?? 'Unknown Sign' }}</p>
                        </div>
                    </a>
                </div>
            </div>
