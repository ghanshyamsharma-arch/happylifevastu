...
@endphp
    ...
    {{-- ── STEP 1: Cinzel + Inter fonts for the theme ── --}}
    ...
    {{-- ── STEP 2: Base stylesheets (framework + app) ── --}}
    ...
    {{-- ── STEP 3: Project custom CSS ── --}}
    <link rel="stylesheet" href="{{ asset('public/frontend/css/newcss.css') }}">

    {{-- ── STEP 4: Theme override — MUST be LAST so it wins all conflicts ── --}}
    <link rel="stylesheet" href="{{ asset('public/frontend/css/theme-override.css') }}">
