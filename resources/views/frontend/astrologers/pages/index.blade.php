...
<script>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    <div class="container my-5 mt-5" style="margin-top: 1.5rem !important;">
        <!-- Full-width inner container exactly as per spec -->
        <div class="container full-slider-container" style="padding-left:0px; padding-right:0px; max-width:100%;">
            <div class="banner-slider-container">
                <!-- Slider Wrapper -->
                <div class="banner-slider" id="bannerSlider">
                    <!-- Banner 1 -->
                    <div class="banner-slide">
                        <a href="#" id="kundaliLink">
                    ...
                    <div class="banner-slide">
                        <a href="#" id="talkLink">
                            <img src="https://placehold.co/1920x650/4A2F2D/F9E0A0?text=Talk+to+Astrologer+🔮" alt="Talk to Astrologer">
                        </a>
                    </div>
                    <!-- Banner 3 -->
                    <div class="banner-slide">
                        <a href="#" id="pujaLink">
                            <img src="https://placehold.co/1920x650/2E5A4C/F9E6CF?text=Book+Puja+🕉️" alt="Book Puja">
                        </a>
                    </div>
                    <!-- Banner 4 -->
                    <div class="banner-slide">
                        <a href="#" id="shopLink">
                            <img src="https://placehold.co/1920x650/5D3A1A/FFE3BC?text=Astro+Shop+🛍️" alt="Astro Shop">
                        </a>
                    </div>
                </div>
                ...
                <!-- Play/Pause Button (extra control as mentioned) -->
