...
<div class="header">
                        ...
                        <div class="dropdown ">
                            ...
                            <div class="dropdown-menu user-options fadeInUp5px dropdown-menu-right dropdown-menu-lg-left"
                                ...
                                <ul>
                                    ...
                                    <li class="d-block">
                                        <div>
                                            <a class="dropdown-item" href="{{ route('my-pujari-slot-bookings') }}">
                                                <span class="mr-2">
    ...
    margin-left: 10px;
">
                <a href="{{ route('front.cart') }}" class="position-relative text-decoration-none">
                    <i class="fa-solid fa-cart-shopping fs-5"></i>
            
                    <span id="cart-badge"
                          class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                        {{ authcheck() ? \App\Models\CartItem::where('userId', auth()->user()->id)->sum('quantity') : 0 }}
                    </span>
                </a>
            </li>
            </div>
        ...
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link font-weight-semi-bold nav-link-mobile"
                            href="{{ route('front.pujariList') }}"><i class="fas fa-om"></i>️ Pujari</a>
                    </li>
