            ...
            <div class="row text-md-left g-4">
                ...
                <div class="col-md-3 col-6 mb-4">
                    ...
                    <ul class="list-unstyled mt-1" style="font-size: 14px">
                        <li class="p-1"><a class="footer-link" href="{{ route('front.pujariLogin') }}">Pujari Login</a></li>
                        <li class="p-1"><a class="footer-link" href="{{ route('front.pujariRegister') }}">Pujari Registration</a></li>
                    </ul>
                    @else
                    <h5 class="text-white p-2 font-16 mt-4 border-bottom border-secondary">Pujari Portal</h5>
                    <ul class="list-unstyled mt-1" style="font-size: 14px">
                        <li class="p-1"><a class="footer-link" href="{{ route('front.pujariDashboard') }}">My Dashboard</a></li>
                        <li class="p-1"><a class="footer-link" href="{{ route('front.pujariLogout') }}" onclick="return confirm('Are you sure you want to logout?')">Logout</a></li>
                    </ul>
                    @endif
                </div>
