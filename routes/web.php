...
use App\Http\Controllers\Admin\PujariAdminController;
use App\Http\Controllers\Admin\BlockPujariController;
use App\Http\Controllers\Admin\PujariReviewController;
use App\Http\Controllers\Admin\PujariBookingController;
// use App\Http\Controllers\Admin\OrderController;
use App\Http\Controllers\Admin\PujariSlotController as AdminPujariSlotController;
...
// ── Pujari CRUD ───────────────────────────────────────────────────────────
Route::get('pujaris',                 [PujariAdminController::class, 'getPujari'])->name('pujaris');
Route::post('pujaris',                [PujariAdminController::class, 'getPujari']);
Route::get('pujari/add',              [PujariAdminController::class, 'addPujari'])->name('addPujari');
Route::post('addPujariApi',           [PujariAdminController::class, 'addPujariApi'])->name('addPujariApi');
Route::post('editPujariApi',          [PujariAdminController::class, 'editPujariApi'])->name('editPujariApi');
Route::post('verifiedPujariApi',      [PujariAdminController::class, 'verifiedPujariApi'])->name('verifiedPujariApi');
Route::delete('deletePujari',         [PujariAdminController::class, 'deletePujari'])->name('deletePujari');
Route::get('pujaris/edit/{id}',       [PujariAdminController::class, 'editPujari'])->name('edit-pujari');
Route::get('pujaris/{id}',            [PujariAdminController::class, 'pujariDetailApi'])->name('pujari-detail');
Route::get('pending-pujari-requests', [PujariAdminController::class, 'getPujariPendingRequest'])->name('pending-pujari-requests');
Route::post('toggleBlockPujariAdmin', [PujariAdminController::class, 'toggleBlock'])->name('toggleBlockPujariAdmin');
 
// ── Block Pujari ─────────────────────────────────────────────────────────
Route::get('block-pujari',              [BlockPujariController::class, 'getBlockPujari'])->name('blockPujari');
Route::post('block-pujari',             [BlockPujariController::class, 'getBlockPujari']);
Route::post('toggleBlockPujari',        [BlockPujariController::class, 'toggleBlockPujari'])->name('toggleBlockPujari');
Route::delete('deleteBlockPujariRecord',[BlockPujariController::class, 'deleteBlockRecord'])->name('deleteBlockPujariRecord');
 
// ── Pujari Reviews ────────────────────────────────────────────────────────
Route::get('pujari-reviews',    [PujariReviewController::class, 'getPujariReviews'])->name('pujariReviews');
Route::post('addPujariReview',  [PujariReviewController::class, 'addReviewFromAdmin'])->name('addPujariReview');
Route::delete('deletePujariReview', [PujariReviewController::class, 'deleteReview'])->name('deletePujariReview');
 
// ── Pujari Bookings ───────────────────────────────────────────────────────
Route::get('pujari-bookings',          [PujariBookingController::class, 'index'])->name('pujariBookings');
Route::post('pujari-bookings',         [PujariBookingController::class, 'index']);
Route::get('pujari-bookings/{id}',     [PujariBookingController::class, 'show'])->name('pujariBookingDetail');
Route::post('updatePujariBookingStatus',[PujariBookingController::class, 'updateStatus'])->name('updatePujariBookingStatus');
Route::delete('deletePujariBooking',   [PujariBookingController::class, 'destroy'])->name('deletePujariBooking');


// ── Pujari Slots (Admin) ──────────────────────────────────────────────────────
Route::get('pujari-slots',             [AdminPujariSlotController::class, 'index'])->name('pujariSlots');
Route::post('pujari-slots',            [AdminPujariSlotController::class, 'index']);
Route::post('addPujariSlot',           [AdminPujariSlotController::class, 'store'])->name('addPujariSlot');
Route::post('updatePujariSlot',        [AdminPujariSlotController::class, 'update'])->name('updatePujariSlot');
Route::post('togglePujariSlotStatus',  [AdminPujariSlotController::class, 'toggleStatus'])->name('togglePujariSlotStatus');
Route::delete('deletePujariSlot',      [AdminPujariSlotController::class, 'destroy'])->name('deletePujariSlot');
Route::get('getPujariSlotsForDate',    [AdminPujariSlotController::class, 'getSlotsForPujari'])->name('getSlotsForPujari');
...
// Add detail view route
Route::get('/order/{orderId}', [OrderController::class, 'getOrderDetail'])->name('admin.order.detail');


// Controller

Route::get('skills', [SkillController::class, 'addSkill'])->name('addSkills');
...
Route::post('editAdsVideoApi', [AdsVideoController::class, 'editAdsVideoApi'])->name('editAdsVideoApi1')->middleware('permission:edit');
...
Route::post('videoStatusApi', [AdsVideoController::class, 'videoStatusApi'])->name('videoStatusApi1')->middleware('permission:status');
...
Route::post('addAdsVideoApi', [AdsVideoController::class, 'addAdsVideoApi'])->name('addAdsVideoApi1');
...
Route::group(['middleware' => ['web']], function () use ($professionTitle) {
    ...
    Route::controller(PageController::class)->group(function () use ($professionTitle) {
        ...
        // Get data Controller
        Route::get('skills', [SkillController::class, 'getSkill'])->name('getskills');
        ...
        Route::get('blogs', [BlogController::class, 'getBlog'])->name('getBlogs');
        ...
        Route::get('adsVideos', [AdsVideoController::class, 'getAdsVideo'])->name('adsVideos1');
