...
use App\Http\Controllers\API\Pujari\PujariController as ApiPujariController;
$session = new Session();
...
Route::post('/getPujari',     [ApiPujariController::class, 'getPujari']);
Route::post('/getPujariById', [ApiPujariController::class, 'getPujariById']);
Route::post('/addPujari',     [ApiPujariController::class, 'addPujari']);
Route::post('/loginPujari',   [ApiPujariController::class, 'loginPujari']);
Route::post('/updatePujari',  [ApiPujariController::class, 'updatePujari']);
Route::post('/deletePujari',  [ApiPujariController::class, 'deletePujari']);
...
Route::post('tnc', [DashboardController::class, 'termscond'])->name('termscondpost');
