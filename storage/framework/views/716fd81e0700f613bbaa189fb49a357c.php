            ...
            <div class="row align-items-center gy-3">
                ...
                <div class="col-sm-12 col-md-2">
                    <select class="sacred-select" name="sortBy" onchange="onSortExpertList()" id="psychicOrderBy">
                        ...
                        <option value="experienceLowToHigh" <?php echo e($sortBy == 'experienceLowToHigh' ? 'selected' : ''); ?>>Low Experience</option>
                        <option value="experienceHighToLow" <?php echo e($sortBy == 'experienceHighToLow' ? 'selected' : ''); ?>>High Experience</option>
                        <option value="priceLowToHigh" <?php echo e($sortBy == 'priceLowToHigh' ? 'selected' : ''); ?>>Lowest Price</option>
                        <option value="priceHighToLow" <?php echo e($sortBy == 'priceHighToLow' ? 'selected' : ''); ?>>Highest Price</option>
                    </select>
                </div>
                <div class="col-sm-12 col-md-2">
                    <select name="astrologerCategoryId" onchange="onFilterExpertCategoryList()" class="sacred-select" id="psychicCategories" style="margin: 2px;">
                        <option value="0" <?php echo e($astrologerCategoryId == '0' ? 'selected' : ''); ?>>All Categories</option>
                        <?php $__currentLoopData = $getAstrologerCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category['id']); ?>" <?php echo e($astrologerCategoryId == $category['id'] ? 'selected' : ''); ?>>
            ...
            <div class="col-lg-12">
                <div id="expert-list" class="py-4">
                    <?php $__currentLoopData = $getAstrologer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $astrologer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div id="ATAAIOfferTile" class="psychic-card" data-astrologer-id="<?php echo e($astrologer['id']); ?>">
                            <ul class="list-unstyled d-flex mb-0">
                                <li class="mr-3 position-relative mb-0">
                                    <a href="<?php echo e(route('front.astrologerDetails', ['slug' => $astrologer['slug']])); ?>">
                                        <div class="psyich-img position-relative">
                                            <?php if($astrologer['profileImage']): ?>
                                                <img loading="lazy"
                                                     src="<?php echo e(Str::startsWith($astrologer['profileImage'], ['http://','https://']) ? $astrologer['profileImage'] : '/' . $astrologer['profileImage']); ?>"
                                    ...
                                    <?php elseif($astrologer['chatStatus'] == 'Offline' || empty($astrologer['chatStatus'])): ?>
                                        ...
                                        <div class="status-badge-txt text-center specific-Clr-Offline">
                                            <span class="tooltipex"><?php echo e($astrologer['chatStatus'] ?? 'Offline'); ?></span>
                                        </div>
                                    <?php else: ?>
                                        <div class="status-badge specific-Clr-Online" title="Online"></div>
                                        <div class="status-badge-txt text-center specific-Clr-Online">
                                            <span class="tooltipex"><?php echo e($astrologer['chatStatus']); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </li>
                                ...
                                <li class="w-100">
                                    ...
                                    <div class="info-text">
                                        <img src="<?php echo e(asset('public/frontend/homeimage/horoscope2.svg')); ?>" class="info-icon" alt="">
                                        <span class="primary-skill"><?php echo e(implode(' | ', array_slice(explode(',', $astrologer['primarySkill']), 0, 3))); ?></span>
                                    </div>

                                    <div class="info-text">
                                        <img src="<?php echo e(asset('public/frontend/homeimage/language-icon.svg')); ?>" class="info-icon" alt="">
                                        <?php echo e(implode(' • ', array_slice(explode(',', $astrologer['languageKnown']), 0, 3))); ?>

                                    </div>

                                    <div class="info-text">
                                        <img src="<?php echo e(asset('public/frontend/homeimage/experience-expert-icon.svg')); ?>" class="info-icon" alt="">
                                        Experience: <?php echo e($astrologer['experienceInYears']); ?> Years
                                    </div>
                                    ...
                                    <div class="info-text">
                                        <span class="exprt-price">
                                            ...
                                            <?php endif; ?>
                                            <?php echo e($astrologer['reportRate']); ?>/Report
                                        </span>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <div class="psy-review-section">
                                    <div>
                                        <span class="colorblack font-12 m-0 p-0 d-block">
                                            <span style="color: var(--gold); font-size: 14px; font-weight: bold;"><?php echo e($astrologer['rating']); ?></span>
                                            <span>
                                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    ...
                                    <div><span style="color: gray; font-size: 12px"><?php echo e($astrologer['totalOrder'] ?? 0); ?> Sacred Sessions</span></div>
                                </div>
                                <div>
                ...
                <?php if($getAstrologer->hasMorePages()): ?>
                    <div class="text-center mb-5">
                        <button id="load-more" class="btn-load-more" data-next-page="<?php echo e($getAstrologer->currentPage() + 1); ?>">
                            ...
                            <div class="mb-3">
                                <form class="px-3 font-14" method="post" id="intakeForm">
                                    <?php if(authcheck()): ?>
                                        ...
                                        <input type="hidden" name="countryCode" value="<?php echo e(authcheck()['countryCode']); ?>">
                                    <?php endif; ?>
                                            ...
                                            <div class="phone-input-group">
                                                <select class="form-control" id="countryCode1" name="countryCode">
                                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="+<?php echo e($country->phonecode); ?>">+<?php echo e($country->phonecode); ?> (<?php echo e($country->iso); ?>)</option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <input class="form-control" id="contact" maxlength="12" name="contactNo" type="number" value="<?php echo e(old('contactNo')); ?>" required>
                                            </div>
                                        </div>
...
$(document).ready(function() {
    ...
    $('#load-more').click(function() {
        ...
        let authcheck = "<?php echo e($authcheck ? true : false); ?>";
...
$(document).ready(function() {
    $('#intakeBtn').click(function(e) {
        ...
        var wallet_amount = parseInt("<?php echo e($walletAmount ?? 0); ?>");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/pages/astrologer-report-list.blade.php ENDPATH**/ ?>