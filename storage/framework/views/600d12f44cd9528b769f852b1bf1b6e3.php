                ...
                <div class="col-md-12 d-flex align-items-center">
                    <span style="text-transform: capitalize; ">
                        <span class="text-white breadcrumbs">
                            ...
                            <i class="fa fa-chevron-right"></i> <a href="<?php echo e(route('front.getMyChat')); ?>"
                                        ...
                                        <?php if(!empty($chatdata)): ?>
                                            <tr>
                                                ...
                                                <td class="text-danger">
                                                    ...
                                                    <?php endif; ?>
                                                <?php echo e(number_format($chatdata['deduction'],2)); ?></div>
                                                </td>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/pages/my-chats.blade.php ENDPATH**/ ?>