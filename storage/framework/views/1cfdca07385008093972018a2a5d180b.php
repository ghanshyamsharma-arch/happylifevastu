                ...
                <div class="scard">
                    ...
                    <div class="scard-img-wrap">
                        <img class="rounded-m"
                             ...
                             onclick="openImage('<?php echo e($firstImage); ?>')" />
                    </div>

                    <!-- Name -->
                    <div class="descrb">
                        <h3 class="font-weight-bold"><?php echo e($category->name); ?></h3>
                    </div>
                    ...
                    <div class="puja-footer">
                        <a href="<?php echo e(route('front.pujaList', $category->id)); ?>" class="read">
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/pages/puja-category-list.blade.php ENDPATH**/ ?>