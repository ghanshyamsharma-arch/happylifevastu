...
<title><?php echo e(ucfirst($appname)); ?> in News</title>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('subcontent'); ?>
<div class="loader"></div>
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto"><?php echo e(ucfirst($appname)); ?> News</h2>
        ...
        <div class="p-5" style="word-break:break-all">
            <div class="h-40 2xl:h-56 image-fit">
                <img class=" cursor-pointer"
                    src="<?php echo e(Str::startsWith( $video['bannerImage'], ['http://','https://']) ? $video['bannerImage'] : '/' . $video['bannerImage']); ?>"
                    onerror="this.onerror=null;this.src='/build/assets/images/person.png';"
                    alt="Customer image"
                    onclick="openImage('<?php echo e(Str::startsWith( $video['bannerImage'], ['http://','https://']) ? $video['bannerImage'] : '/' . $video['bannerImage']); ?>')" />
            </div>
            ...
            <div class="text-slate-600 dark:text-slate-500 mt-2">
                ...
                <?php echo \Illuminate\Support\Str::words($video['description'], 30, '...'); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="font-medium text-base mr-auto">Add <?php echo e(ucfirst($appname)); ?> News</h2>
            </div>
            <form id="add-form" method="POST" enctype="multipart/form-data">
                ...
                <div id="input" class="p-5">
                    <div class="preview">
                        ...
                        <div class="mt-5"><button class="btn btn-primary shadow-md mr-2">Add <?php echo e(ucfirst($appname)); ?> News</button>
                        </div>
                    </div>
                </div>
            </form>
...
<div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="font-medium text-base mr-auto">Edit <?php echo e(ucfirst($appname)); ?>News</h2>
            </div>
    ...
    <nav class="w-full sm:w-auto sm:mr-auto" aria-label="adsVideo">
        <ul class="pagination">
            <li class="page-item <?php echo e($page == 1 ? 'disabled' : ''); ?>">
                <a class="page-link" href="<?php echo e(route('astroguruNews', ['page' => $page - 1])); ?>">
            ...
            <?php for($i = 0; $i < $totalPages; $i++): ?>
                ...
                <a class="page-link"
                    href="<?php echo e(route('astroguruNews', ['page' => $i + 1])); ?>"><?php echo e($i + 1); ?></a>
                </li>
                <?php endfor; ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/pages/news.blade.php ENDPATH**/ ?>