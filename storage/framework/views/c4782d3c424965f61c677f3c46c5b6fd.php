        ...
        <tbody>
            ...
            <?php $__currentLoopData = $story; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="intro-x">
                    ...
                    <td>
                        <div class="flex">
                            <div class="w-10 h-10 image-fit zoom-in">
                                <img class="rounded-full cursor-pointer" src="<?php echo e(Str::startsWith($stori->profileImage, ['http://','https://']) ? $stori->profileImage : '/' . $stori->profileImage); ?>" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('<?php echo e($stori->profileImage); ?>')" />
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="text-center"><?php echo e(date('d-m-Y h:i a', strtotime($stori->created_at))); ?></td>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/pages/story-list.blade.php ENDPATH**/ ?>