                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="sacred-form-group">
                                            ...
                                            <input autocomplete="off" class="sacred-input" id="EmailAddress"
                                                ...
                                                value="<?php echo e($getuserdetails['userDetails']['email']); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="phone-input-group">
                                                <select class="country-code-select" id="countryCode1" name="countryCode">
                                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option data-country="in" value="<?php echo e($getuserdetails['userDetails']['countryCode'] ?? $country->phonecode); ?>" data-ucname="India">
                                                ...
                                                <input autocomplete="off" class="sacred-input flex-grow-1" id="ContactMobile" name="contactNo" type="tel" 
                                                       value="<?php echo e($getuserdetails['userDetails']['contactNo']); ?>" pattern="\d{10}" inputmode="numeric" 
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="sacred-form-group">
                                            ...
                                            <select class="sacred-select" data-val="true" id="Gender" name="gender" required>
                                                <option value=""
                                                    <?php echo e($getuserdetails['userDetails']['gender'] == 0 ? 'selected' : ''); ?>>
                                                    -- Select --</option>
                                                <option value="Male"
                                                    <?php echo e($getuserdetails['userDetails']['gender'] == 'Male' ? 'selected' : ''); ?>>
                                                    Male</option>
                                                <option value="Female"
                                                    <?php echo e($getuserdetails['userDetails']['gender'] == 'Female' ? 'selected' : ''); ?>>
                                                    Female</option>
                                                <option value="Other"
                                                    <?php echo e($getuserdetails['userDetails']['gender'] == 'Other' ? 'selected' : ''); ?>>
                                                    Other</option>
                                            </select>
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="sacred-form-group">
                                            ...
                                            <input type="date" name="birthDate" class="sacred-input"
                                                value="<?php echo e(date('Y-m-d', strtotime($getuserdetails['userDetails']['birthDate']))); ?>" required>
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="sacred-form-group">
                                            ...
                                            <input autocomplete="off" name="birthPlace"
                                                ...
                                                value="<?php echo e($getuserdetails['userDetails']['birthPlace']); ?>" required>
                                            <span class="field-validation-valid text-danger" data-valmsg-for="POB"
                                                data-valmsg-replace="true"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="sacred-form-group">
                                            ...
                                            <input autocomplete="off" class="sacred-input" id="PinCode"
                                                ...
                                                value="<?php echo e($getuserdetails['userDetails']['pincode']); ?>">
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="sacred-form-group">
                                            ...
                                            <div class="profile-image-wrapper">
                                                <?php if($getuserdetails['userDetails']['profile']): ?>
                                                    <img class="profile-preview" 
                                                         src="<?php echo e(Str::startsWith($getuserdetails['userDetails']['profile'], ['http://','https://']) ? $getuserdetails['userDetails']['profile'] : '/' . $getuserdetails['userDetails']['profile']); ?>" 
                                                         onerror="this.onerror=null;this.src='/build/assets/images/person.png';" 
                                                         alt="Profile" 
                                                         onclick="openImage('<?php echo e($getuserdetails['userDetails']['profile']); ?>')">
                                                <?php endif; ?>
                                ...
                                <div class="referral-card-body">
                                    ...
                                    <div class="referral-link-group">
                                        <input class="referral-input" type="url" readonly id="referralLink"
                                            value="<?php echo e(env('APP_URL') . '?ref=' . $getuserdetails['userDetails']['referral_token']); ?>">
                            ...
                            <div class="referral-card">
                                ...
                                <div class="referral-card-body">
                                    <div class="how-it-works-text">
                                        <p><i class="fa fa-user-plus"></i> Your friend must sign up on <?php echo e($appname); ?> using your referral code.</p>
                                        <p><i class="fa fa-star"></i> Your friend must be a first time user of <?php echo e($appname); ?></p>
                                        <p><i class="fa fa-gift"></i> You will get <strong class="color-red"><?php echo e($currency->value); ?><?php echo e($referral_settings->amount); ?></strong> when your friend signs up on <?php echo e($appname); ?> using your referral code.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
?>
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e($apikey->value); ?>&libraries=places"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/pages/my-account.blade.php ENDPATH**/ ?>