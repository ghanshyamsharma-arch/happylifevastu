...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
        function editbtn($id, $bannerImage, $fromDate, $toDate, $bannerTypeId) {
            ...
            // Fix: Add proper path handling
            var imagePath = $bannerImage;
            if (imagePath && !imagePath.startsWith('http')) {
                imagePath = '/' + imagePath;
            }
            document.getElementById("thumbs").src = imagePath;
        }
        ...
        // Fixed preview function for Add Banner
        ...
        // Fixed preview function for Edit Banner
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/pages/banner-list.blade.php ENDPATH**/ ?>