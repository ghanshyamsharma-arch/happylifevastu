...
<div class="header">
                        ...
                        <div class="dropdown ">
                            ...
                            <div class="dropdown-menu user-options fadeInUp5px dropdown-menu-right dropdown-menu-lg-left"
                                ...
                                <ul>
                                    ...
                                    <li class="d-block">
                                        <div>
                                            <a class="dropdown-item" href="<?php echo e(route('my-pujari-slot-bookings')); ?>">
                                                <span class="mr-2">
                                                    <i class="fa fa-calendar"></i>
                                                </span>
                                                <span>My Pujari Slot Bookings</span>
                                            </a>
                                        </div>
                                    </li>
                                    <li class="d-block">
    ...
    margin-left: 10px;
">
                <a href="<?php echo e(route('front.cart')); ?>" class="position-relative text-decoration-none">
                    <i class="fa-solid fa-cart-shopping fs-5"></i>
            
                    <span id="cart-badge"
                          class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                        <?php echo e(authcheck() ? \App\Models\CartItem::where('userId', auth()->user()->id)->sum('quantity') : 0); ?>
        ...
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <!-- NEW: Pujari List Link -->
                    <li class="nav-item">
                        <a class="nav-link font-weight-semi-bold nav-link-mobile"
                            href="<?php echo e(route('front.pujariList')); ?>"><i class="fas fa-om"></i>️ Pujari</a>
                    </li>
...
<!-- Include script before closing body tag --><?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/layout/header.blade.php ENDPATH**/ ?>