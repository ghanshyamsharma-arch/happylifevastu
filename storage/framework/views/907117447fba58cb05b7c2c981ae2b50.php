                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 contact-left">
                        <div class="contact-card h-100">
                            ...
                            <h2 class="company-name"><?php echo $appName->value; ?></h2>
                            <span class="company-subtext">Consult Online <?php echo e(ucfirst($professionTitle)); ?> Anytime</span>
                            ...
                            <div class="contact-info-item">
                                ...
                                <span>Customer Support: <strong><?php echo $sitenumber; ?></strong></span>
                            </div>
                            
                            <div class="contact-info-item">
                                <i class="fa fa-envelope"></i>
                                <a href="mailto:support@anytimeastro.com"><?php echo $siteemail; ?></a>
                            </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/pages/contact.blade.php ENDPATH**/ ?>