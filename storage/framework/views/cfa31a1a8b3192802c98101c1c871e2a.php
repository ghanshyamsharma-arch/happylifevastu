...
<?php $__env->startSection('subcontent'); ?>
    ...
    <div class="flex items-center mt-8">
        <h2 class="intro-y text-lg font-medium mr-auto">
            ...
            <?php if(isset($pujaris) && count($pujaris) > 0): ?>
                <span class="ml-2 px-2 py-1 text-xs rounded-full bg-warning text-white"><?php echo e(count($pujaris)); ?></span>
            <?php endif; ?>
        </h2>
    ...
    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible list-table mt-5">
        <table class="table table-report -mt-2">
            ...
            <tbody>
                ...
                <tr class="intro-x" id="row_<?php echo e($pujari->id); ?>">
                    <td><?php echo e(++$no); ?></td>
                    <td>
                    ...
                    <td class="font-medium"><?php echo e($pujari->name); ?></td>
                    <td class="text-center">
                        <?php echo e($pujari->contactNo); ?><br>
                        <span class="text-slate-500 text-xs"><?php echo e($pujari->email); ?></span>
                    </td>
                    <td class="text-center"><?php echo e(Str::limit($pujari->primarySkill, 30)); ?></td>
                    <td class="text-center"><?php echo e($pujari->currentCity ?? '-'); ?></td>
                    <td class="text-center"><?php echo e(\Carbon\Carbon::parse($pujari->created_at)->format('d M Y')); ?></td>
                    <td class="text-center">
                        <div class="flex items-center justify-center gap-2">
                            <button class="btn btn-sm btn-success shadow-sm approvePujari" data-id="<?php echo e($pujari->id); ?>">
                                <i data-lucide="check" class="w-3 h-3 mr-1"></i> Approve
                            </button>
                            <button class="btn btn-sm btn-danger shadow-sm rejectPujari" data-id="<?php echo e($pujari->id); ?>">
                                <i data-lucide="x" class="w-3 h-3 mr-1"></i> Reject
                            </button>
                        </div>
                    </td>
                    <td class="text-center">
                        <a href="<?php echo e(route('pujari-detail', $pujari->id)); ?>" class="flex items-center justify-center text-primary">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/pages/pujari-pending.blade.php ENDPATH**/ ?>