            ...
            <div class="row">
                <div class="col-sm-12 expert-search-section-height-favourites">
                    ...
                    <div class="list py-4 " id="expert-list">
                        ...
                        <?php $__currentLoopData = $getfollowing['recordList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $astrologer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <ul class="list-unstyled d-flex mb-0">
                            <li class="mr-3 position-relative psychic-presence status-online" data-status="online">
                                <div class="psyich-img position-relative">
                                    ...
                                    <img class="rounded-m" src="<?php echo e(Str::startsWith($astrologer['profileImage'], ['http://','https://']) ? $astrologer['profileImage'] : '/' . $astrologer['profileImage']); ?>" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('<?php echo e($astrologer['profileImage']); ?>')" />
                                    <?php else: ?>
                            ...
                            <li class=" colorblack">
                                ...
                                <?php if($astrologer['isFreeAvailable'] == true): ?>
                                    <span class="font-13 font-weight-semi-bold d-flex">
                                        <span class="exprt-price"><img src="<?php echo e(asset('public/frontend/homeimage/rupee-coin-outline-icon.svg')); ?>" height="16" width="16" alt="">&nbsp; <del> <?php echo e($currency['value']); ?><?php echo e($astrologer['charge']); ?></del>/Min</span>
                                        <span class="free-badge text-uppercase color-red ml-2">Free</span>
                                    </span>
                                <?php else: ?>
                                    <span class="font-13 font-weight-semi-bold d-flex">
                                        <span class="exprt-price"><img src="<?php echo e(asset('public/frontend/homeimage/rupee-coin-outline-icon.svg')); ?>" height="16" width="16" alt="">&nbsp; <?php echo e($currency['value']); ?><?php echo e($astrologer['charge']); ?>/Min</span>
                                    </span>
                                <?php endif; ?>
                            </li>
                        </ul>
                                ...
                                <div class="row">
                                    <div class="psy-review-section col-12">
                                        <div>
                                            <span class="colorblack font-12 m-0 p-0 d-block">
                                                <span style="color: #b76700;font-size: 14px;font-weight: bold;"><?php echo e($astrologer['rating']); ?></span>
                                                <span>
                                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        ...
                                        <div><span style="color: gray;font-size: 12px"><?php echo e($astrologer['totalOrder']); ?> Sessions</span></div>
                                    </div>
                                    <div class="col-3 responsiveChatBtn mt-1" >
                                        <?php if($astrologer['chatStatus'] == 'Busy' || $astrologer['chatStatus'] == 'Offline' || empty($astrologer['chatStatus'])): ?>
                                            <a class="btn-block btn btn-call align-items-center" style="font-size: 14px !important;" href="<?php echo e(route('front.astrologerDetails',  ['slug' => $astrologer['slug']])); ?>" >
                                                <i class="fa-solid fa-circle-info mr-2"></i> <span>View</span></a>
                                        <?php elseif($astrologer['chat_sections'] == 0 || $Chatsection['value'] == 0): ?>
                                            <a class="btn-block btn btn-call align-items-center disabled" href="<?php echo e(route('front.astrologerDetails',  ['slug' => $astrologer['slug']])); ?>" >
                                                <i class="fa-solid fa-circle-info mr-2"></i> <span>View</span>
                                            </a>
                                        <?php else: ?>
                                            <a class="btn-block btn btn-call align-items-center"  role="button" href="<?php echo e(route('front.astrologerDetails',  ['slug' => $astrologer['slug']])); ?>" >
                                                <i class="fa-solid fa-circle-info mr-2"></i> <span>View</span>
                                            </a>
                                        <?php endif; ?>
                                    </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/pages/my-following.blade.php ENDPATH**/ ?>