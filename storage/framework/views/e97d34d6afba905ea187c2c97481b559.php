            ...
            <div class="row afterLoginDisplay">
                <div class="col-md-12 d-flex align-items-center">
                    <span class="breadcrumbs">
                        ...
                        <a href="<?php echo e(route('front.cart')); ?>">Cart</a>
                        <i class="fa fa-chevron-right"></i>
                                                ...
                                                <div class="modal-form-group">
                                                    ...
                                                    <div class="country-code-wrapper">
                                                        <select class="country-code-select" id="countryCode" name="countryCode" style="width:34%">
                                                            <?php $__empty_1 = true; $__currentLoopData = $countries2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <form class="px-3 font-14" method="post" id="orderForm" autocomplete="off">
                                ...
                                <div class="table-responsive mt-3 mb-4">
                                    <table class="address-table">
                                        ...
                                        <?php else: ?>
                                            <?php $__currentLoopData = $addressList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(!empty($addr) && is_array($addr)): ?>
                                                <tr>
                                                    <td data-label="Select">
                                                        <input type="radio" name="orderAddressId" value="<?php echo e($addr['id'] ?? ''); ?>" required>
                                                    </td>
                                                    <td data-label="Name"><?php echo e($addr['name'] ?? 'N/A'); ?></td>
                                                    <td data-label="Phone"><?php echo e($addr['phoneNumber'] ?? 'N/A'); ?></td>
                                                    <td data-label="Address">
                                                        <?php echo e($addr['flatNo'] ?? ''); ?>

                                                        <?php if(!empty($addr['locality'])): ?>, <?php echo e($addr['locality']); ?><?php endif; ?>
                                                        <?php if(!empty($addr['landmark'])): ?>, <?php echo e($addr['landmark']); ?><?php endif; ?>
                                                        <?php if(!empty($addr['city'])): ?>, <?php echo e($addr['city']); ?><?php endif; ?>
                                                        <?php if(!empty($addr['state'])): ?>, <?php echo e($addr['state']); ?><?php endif; ?>
                                                        <?php if(!empty($addr['country'])): ?>, <?php echo e($addr['country']); ?><?php endif; ?>
                                                        <?php if(!empty($addr['pincode'])): ?> - <?php echo e($addr['pincode']); ?><?php endif; ?>
                                                    </td>
                                                </tr>
                                                <?php endif; ?>
                            ...
                            <div class="summary-content">
                                ...
                                <div class="order-items">
                                    <div class="order-items-title">
                                        <i class="fa fa-shopping-bag mr-1"></i> Items (<?php echo e(count($cartItems)); ?>)
                                    </div>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <div class="order-item">
                                            ...
                                            <div class="order-item-details">
                                                ...
                                                <div class="order-item-qty">Quantity: <?php echo e($item->quantity); ?></div>
                                            </div>
                                            <div class="order-item-price">
                                                <?php echo e($currency->value ?? '₹'); ?><?php echo e(number_format($item->product->getRawOriginal('amount') * $item->quantity, 2)); ?>
                                ...
                                <div class="price-breakdown">
                                    <div class="price-row">
                                        ...
                                        <span class="price-value"><?php echo e($currency->value ?? '₹'); ?><?php echo e(number_format($subtotal, 2)); ?></span>
                                    </div>
                                    <?php if($gstPercent > 0): ?>
                                    <div class="price-row">
                                        <span class="price-label">GST (<?php echo e($gstPercent); ?>%)</span>
                                        <span class="price-value"><?php echo e($currency->value ?? '₹'); ?><?php echo e(number_format($gstAmount, 2)); ?></span>
                                    </div>
                                    <?php endif; ?>
                                    <div class="total-row">
                                        <span class="total-label">Total</span>
                                        <span class="total-value"><?php echo e($currency->value ?? '₹'); ?><?php echo e(number_format($total, 2)); ?></span>
                                    </div>
                                </div>

                                <!-- Hidden fields -->
                                <input type="hidden" id="checkout-total" value="<?php echo e($total); ?>">
                                <input type="hidden" id="checkout-subtotal" value="<?php echo e($subtotal); ?>">
                                <input type="hidden" id="checkout-gst" value="<?php echo e($gstPercent); ?>">
...
$(document).ready(function() {
    $('#addressBtn').click(function(e) {
        ...
        $.ajax({
            url: '/api/orderAddress/add?token=<?php echo e($token); ?>',
            type: 'POST',
...
function placeCartOrder(addressId, paymentMethod) {
    fetch('<?php echo e(route("cart.placeOrder")); ?>', {
        method: 'POST',
        headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/pages/checkout.blade.php ENDPATH**/ ?>