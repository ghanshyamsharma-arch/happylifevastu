                        ...
                        <div class="sm:grid grid-cols-12 gap-2 mt-3">
                            <div class="col-span-6">
                                ...
                                <input type="text" id="amount" name="amount" class="form-control"
                                    placeholder="Enter Amount In INR" required >
                            </div>
                            <div class="col-span-6">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/pages/add-product.blade.php ENDPATH**/ ?>