    ...
    <div class="register-container">
        <div class="register-card">
            ...
            <div class="register-body">
                ...
                <form id="registerForm" method="POST" action="<?php echo e(route('front.pujariVerifyLogin')); ?>">
                    <?php echo csrf_field(); ?>
                ...
                <div class="form-footer">
                    <p>Already have an account? <a href="<?php echo e(route('front.pujariLogin')); ?>">Login here</a></p>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/pujari/pages/register.blade.php ENDPATH**/ ?>