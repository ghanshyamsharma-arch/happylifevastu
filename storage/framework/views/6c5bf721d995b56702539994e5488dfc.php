      ...
      <select name="productCategoryId" onchange="onFilterProductCategoryList()" class="form-control filter-select rounded shadow-sm border-0" id="psychicCategories">
        ...
        <?php $__currentLoopData = ($getproductCategory['recordList'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($category['id'] ?? ''); ?>" <?php echo e(($productCategoryId ?? '') == ($category['id'] ?? '') ? 'selected' : ''); ?>>
            <?php echo e($category['name'] ?? 'Unnamed Category'); ?>
              ...
              <div class="d-flex flex-column justify-content-between flex-grow-1 p-3">
                ...
                <div class="d-flex justify-content-between align-items-center mt-auto">
                  ...
                  <button class="btn btn-add-cart" 
                    data-product-id="<?php echo e($products->id); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/pages/products.blade.php ENDPATH**/ ?>