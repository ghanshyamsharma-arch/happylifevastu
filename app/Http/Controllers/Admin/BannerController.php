    ...
    public function addBannerApi(Request $req)
    {
        try {
            if (Auth::guard('web')->check()) {
                ...
                // Step 3: Handle image upload - DIRECT SAVE (NO StorageHelper)
                if ($req->hasFile('bannerImage')) {
                    ...
                    $path = 'public/uploads/banners/' . $fileName;
                }
        ...
        try {
            if (Auth::guard('web')->check()) {
                ...
                if ($req->hasFile('bannerImage')) {
                    ...
                    if ($banner->bannerImage && file_exists(public_path($banner->bannerImage))) {
                        unlink(public_path($banner->bannerImage));
                    }
