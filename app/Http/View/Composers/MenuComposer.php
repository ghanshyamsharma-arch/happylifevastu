...
class MenuComposer
{
     ...
     * Updated with Pujari session connectivity check
     *
     * @param  View  $view
     * @return void
     */
    public function compose(View $view)
    {
        if (!is_null(request()->route())) {
            ...
            // NEW: Pujari session connectivity check
            $pujariSession = session('pujari');
            $view->with('pujari_logged_in', !empty($pujariSession));
            $view->with('pujari_data', $pujariSession);
        }
    }
