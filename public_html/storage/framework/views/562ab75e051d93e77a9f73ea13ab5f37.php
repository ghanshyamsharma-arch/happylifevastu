<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            <div class="row py-3">
                <div class="col-12 col-md-12 mt-4 cat-pages-hide">
                    ...
                    <div class="row pt-4">
    <?php if(isset($gethoroscopesign['recordList']) && is_array($gethoroscopesign['recordList']) && count($gethoroscopesign['recordList']) > 0): ?>
                ...
                <div class="shadow-pink-down text-center p-3 hover-border-red rounded-10">
                    <a href="<?php echo e(route('front.dailyHoroscope', ['slug' => $horoscopesign['slug'] ?? ''])); ?>"
                       title="<?php echo e($horoscopesign['name'] ?? ''); ?>" class="text-decoration-none text-dark">
                        <div>
                            <?php
                                $imageSrc = isset($horoscopesign['image']) ? 
                                    (Str::startsWith($horoscopesign['image'], ['http://','https://']) ? 
                                        $horoscopesign['image'] : '/' . $horoscopesign['image']) : 
                                    '/build/assets/images/person.png';
                            ?>
                            <img style="height: 110px;width:110px" 
                                 src="<?php echo e($imageSrc); ?>" 
                                 onerror="this.onerror=null;this.src='/build/assets/images/person.png';" 
                                 alt="<?php echo e($horoscopesign['name'] ?? 'Horoscope Sign'); ?>" />
                        </div>
                        <div class="">
                            <p class="font-weight-bold mb-0 mt-2 color-red"><?php echo e($horoscopesign['name'] ?? 'Unknown Sign'); ?></p>
                        </div>
                    </a>
                </div>
            </div>
    ...
    <?php else: ?>
        <div class="col-12 text-center py-5">
            <p class="text-muted">No horoscope signs available at the moment.</p>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/pages/horoscopesign.blade.php ENDPATH**/ ?>