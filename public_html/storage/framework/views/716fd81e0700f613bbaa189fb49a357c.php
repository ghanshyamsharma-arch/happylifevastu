...
<?php
    ...
    try {
        ...
        \Log::error('Failed to fetch Google Maps API key in astrologer-report-list: ' . $e->getMessage());
    }
?>
...
<?php else: ?>
    <script>
        console.warn('Google Maps API key not available in astrologer-report-list page');
...
<script>
                            ...
                            html += `
                                <div id="ATAAIOfferTile" class="psychic-card overflow-hidden expertOnline ask-guruji" data-astrologer-id="${astrologer.id}">
                                    <ul class="list-unstyled d-flex mb-0">
                                                ...
                                                <div class="psyich-img position-relative">
                                                    ${astrologer.profileImage ? `
                                                        <img src="${astrologer.profileImage.startsWith('http') ? astrologer.profileImage : '/' + astrologer.profileImage}" 
                                                             width="85" height="85" style="border-radius:50%;" loading="lazy"
                                        ...
                                        <li class="w-100">
                                            <span class="colorblack font-weight-bold font16 mt-0 ml-0 mr-0 mb-0 p-0 text-capitalize d-block" 
                                                  data-toggle="tooltip" title="" 
                                                  style="font-weight: bold;color: #495057 !important;">
                                                ${astrologer.name}
                                                <svg id="Layer_1" fill="#495057" height="16" width="16" data-name="Layer 1" 
                                                     xmlns="http://www.w3.org/2000/svg" viewBox="0 0 106.11 122.88">
                                            ...
                                            <span class="font-13 d-block">
                                                <img src="<?php echo e(asset('public/frontend/homeimage/experience-expert-icon.svg')); ?>" height="16" width="16" alt="">&nbsp; 
                                        ...
                                        <div class="d-block">
                                            <div class="row">
                                                <div class="psy-review-section col-12">
                                                    <div>
                                                        <span class="colorblack font-12 m-0 p-0 d-block">
                                                            <span style="color: #495057;font-size: 14px;font-weight: bold;">${astrologer.rating || 0}</span>
                                                            <span>
                                                                ${Array.from({ length: 5 }, (_, i) => `
                                                                    ${i < Math.round(astrologer.rating || 0) ? `
                                                                        <i class="fas fa-star filled-star" style="font-size:10px"></i>
                                                                    ` : `
                                                                        <i class="far fa-star empty-star" style="font-size:10px"></i>
                                                                    `}
    ...
    function initializeAutocomplete(inputId) {
        ...
        if (typeof google === 'undefined' || typeof google.maps === 'undefined' || typeof google.maps.places === 'undefined') {
            console.warn('Google Maps Places library not loaded. Autocomplete disabled for: ' + inputId);
            return;
        }
        ...
        try {
            ...
            autocomplete.addListener('place_changed', function() {
                ...
                // Note: You need to have latitude and longitude fields in your form
                // Uncomment and adjust these IDs based on your actual form fields
            ...
            console.error('Error initializing autocomplete for ' + inputId + ':', e);
        }
    }
    ...
    <?php else: ?>
    function initializeAutocomplete(inputId) {
        console.warn('Google Maps API key not available. Autocomplete disabled for: ' + inputId);
    }
    <?php endif; ?>
