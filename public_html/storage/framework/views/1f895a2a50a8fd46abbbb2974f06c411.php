                                ...
                                <a href="<?php echo e(route('front.dailyHoroscope', ['slug' => $horoscopesign['slug']])); ?>"
                                    ...
                                    <div class="text-center mb-2 mb-md-0">
                                        <div class="icon border-0 bg-pink">
                                            <img class="rounded-full cursor-pointer" src="<?php echo e(Str::startsWith($horoscopesign['image'], ['http://','https://']) ? $horoscopesign['image'] : '/' . $horoscopesign['image']); ?>" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('<?php echo e($horoscopesign['image']); ?>')" />
                                        </div>
                    ...
                    <div class="row pt-2">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade show active" id="dailyData">
                                <?php if(!empty($horoscope['vedicList']['todayHoroscope'][0])): ?>
                                <h2 class="cat-heading mb-4">Free <span
                                        class="color-red"><?php echo e($horoscope['vedicList']['todayHoroscope'][0]['zodiac']); ?></span>
                                    Daily
                                    Horoscope, <?php echo e(date("d-m-Y", strtotime($horoscope['vedicList']['todayHoroscope'][0]['date']))); ?>

                                </h2>
                                <div class="d-md-flex align-items-start">
                                    <img class="rounded-full cursor-pointer" src="<?php echo e(Str::startsWith($signRcd[0]->image, ['http://','https://']) ? $signRcd[0]->image : '/' . $signRcd[0]->image); ?>" onerror="this.onerror=null;this.src='/build/assets/images/person.png';" alt="Customer image" onclick="openImage('<?php echo e($signRcd[0]->image); ?>')" />
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade" id="weeklyData">
                                <?php if(!empty($horoscope['vedicList']['weeklyHoroScope'][0])): ?>
                                <h2 class="cat-heading mb-4">Free <span
                                    class="color-red"><?php echo e($horoscope['vedicList']['weeklyHoroScope'][0]['zodiac']); ?></span>
                                Weekly
                                Horoscope, <?php echo e(date("d-m-Y" , strtotime($horoscope['vedicList']['weeklyHoroScope'][0]['start_date']))); ?> To
                                <?php echo e(date("d-m-Y" , strtotime($horoscope['vedicList']['weeklyHoroScope'][0]['end_date']))); ?>
                                        ...
                                        <div class="shadow-pink rounded-10">
                                            <div class="bg-pink">
                                                <h3 class="text-center font-weight-bold color-red py-2">Weekly's Lucky
                                                    ...
                                                    and
                                                    Number For
                                                    <?php echo e($horoscope['vedicList']['weeklyHoroScope'][0]['zodiac']); ?>
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade " id="yearlyData">
                                <?php if(!empty($horoscope['vedicList']['yearlyHoroScope'][0])): ?>
                                <h2 class="cat-heading mb-4">Free <span
                                        class="color-red"><?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['zodiac']); ?></span>
                                    Yearly
                                ...
                                <div class="d-md-flex align-items-start ">
                                    ...
                                    <div class="media-body">
                                        <div class="dailyhoroscope-content mt-3">
                                            ...
                                            <p>Health Remark :</p>
                                            <p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['health_remark']); ?></p>
                                            <p>Relationship Remark :</p>
                                            <p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['relationship_remark']); ?>

                                            </p>
                                            <p>Travel Remark :</p>
                                            <p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['travel_remark']); ?></p>
                                            <p>Family Remark :</p>
                                            <p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['family_remark']); ?></p>
                                            <p>Friends Remark :</p>
                                            <p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['friends_remark']); ?></p>
                                            <p>Finances Remark :</p>
                                            <p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['finances_remark']); ?></p>
                                            <p>Status Remark :</p>
                                            <p> <?php echo e($horoscope['vedicList']['yearlyHoroScope'][0]['status_remark']); ?></p>
                                        </div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/pages/dailyhoroscope.blade.php ENDPATH**/ ?>