        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center">
            ...
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
               ...
               <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-auto">
                <form action="<?php echo e(route('astrologers')); ?>" method="GET" enctype="multipart/form-data" id="filterForm">
                    <!-- From Date -->
                        ...
                        <div class="flex">
                            <div class="w-10 h-10 image-fit zoom-in">
                                <img class="rounded-full cursor-pointer" 
                                    ...
                                    onclick="openImage('<?php echo e(Str::startsWith($astro->profileImage, ['http://','https://']) ? $astro->profileImage : '/' . $astro->profileImage); ?>')"/>
                            </div>
                        </div>
                    </td>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        document.getElementById('clearButton').addEventListener('click', function () {
            ...
            window.location.href = "<?php echo e(route('astrologers')); ?>"; // Redirect to remove query parameters
        });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/pages/astrologer-list.blade.php ENDPATH**/ ?>