...
<?php $__env->startSection('subcontent'); ?>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
      ...
      <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-auto">
        <form action="<?php echo e(route('tickets')); ?>" method="GET" enctype="multipart/form-data" id="filterForm">
            <!-- From Date -->
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $tickit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="intro-x">
                                ...
                                <td>
                                    <div class="font-medium text-center"><?php echo e(date('d-m-Y h:i a', strtotime($ticket->created_at))); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        window.location.href = "<?php echo e(route('tickets')); ?>"; // Redirect to remove query parameters
    });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/pages/ticket.blade.php ENDPATH**/ ?>