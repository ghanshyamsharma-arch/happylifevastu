            ...
            <div class="col-md-12 d-flex align-items-center">
                ...
                <span style="text-transform: capitalize; ">
                    <span class="text-white breadcrumbs">
                        ...
                        <i class="fa fa-chevron-right"></i> <span class="breadcrumbtext"><?php echo e(ucfirst($professionTitle)); ?> Registration</span>
                    </span>
                </span>
...
<div class="container py-5">
    <div class="container py-5">
        ...
        <div class="row pt-3 pb-lg-5">
            <div class="col-lg-6 col-12 order-lg-1">
                <form action="<?php echo e(route('front.astrologerstore')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="step1"
                        ...
                        <h2 class="py-3 text-center"><small class="font-weight-bold"><?php echo e(ucfirst($professionTitle)); ?> Sign Up - Personal
                                Details</small></h2>
                        <div class="row">

                            <div class="col-md-6 mb-3">
                                <label for="name">Name<span class="red-color font-weight-bold">*</span></label>
                                <input type="text" id="name" value="<?php echo e(old('name')); ?>" name="name" class="form-control rounded" required pattern="^[a-zA-Z\s]{2,50}$" title="Name should contain only letters and be between 2 and 50 characters long."
                                    oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')">

                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="email">Email Address<span class="red-color font-weight-bold">*</span></label>
                                <input type="email" id="email" value="<?php echo e(old('email')); ?>" name="email" class="form-control rounded" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control select2" name="country" id="country" required>
                                    ...
                                    <option value="<?php echo e($countryName->nicename); ?>" <?php echo e((collect(old('country'))->contains($countryName->nicename)) ? 'selected' : ''); ?>><?php echo e($countryName->nicename); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="d-flex inputform country-dropdown-container" style="border: 1px solid #ddd; border-radius: 4px; overflow: hidden;">
                                    ...
                                    <!-- Mobile Number Input -->
                                    <input class="form-control mobilenumber text-box single-line" id="contact" oninput="enforceMaxLength(this, 10)" name="contactNo" type="number" value="<?php echo e(old('contactNo')); ?>" style="border: none; border-radius: 0; width: 130%;" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div>
                                    <input type="number" value="<?php echo e(old('whatsappNo')); ?>" id="whatsappNo" name="whatsappNo" class="form-control"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="file" class="form-control" value="<?php echo e(old('profileImage')); ?>" id="profileImage" name="profileImage" style="height: 44px" required accept="image/*">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="<?php echo e($inputName); ?>"><?php echo e($document->name); ?></label>
                                <input type="file" class="form-control" value="<?php echo e(old($inputName)); ?>" id="<?php echo e($inputName); ?>" name="<?php echo e($inputName); ?>" style="height: 44px" accept="image/*">
                            </div>
                            ...
                            <div class="form-check">
                                ...
                                <label class="text-dark">
                                    <small>
                                        ...
                                        I Agree To <?php echo e(ucfirst($appname)); ?> <a class="text-dark" style="color:#EE4E5E !important"
                                            href="<?php echo e(route('front.astrologerTermsCondition')); ?>" target="_blank">Terms Of Use</a>&nbsp;and&nbsp;<a
                                            class="text-dark" style="color:#EE4E5E !important" href="<?php echo e(route('front.astrologerPrivacyPolicy')); ?>"
                    ...
                    <div id="step2"
                        ...
                        <h2 class="py-3 text-center"><small class="font-weight-bold"><?php echo e(ucfirst($professionTitle)); ?> Sign Up - Skill Details</small>
                        </h2>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div>
                                    ...
                                    <input type="number" value="<?php echo e(old('aadharNo')); ?>" id="aadharNo" name="aadharNo" class="form-control rounded-right"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" value="<?php echo e(old('pancardNo')); ?>" id="pancardNo" name="pancardNo" class="form-control rounded-right"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" value="<?php echo e(old('charge_usd')); ?>" id="charge_usd" name="charge_usd" class="form-control rounded"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="videoCallRate_usd">Add your video charge(as per min in USD) <span class="red-color font-weight-bold">*</span></label>
                                <input type="text" value="<?php echo e(old('videoCallRate_usd')); ?>" id="videoCallRate_usd" name="videoCallRate_usd"
                                    class="form-control rounded" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="reportRate_usd">Add your report charge ( in USD) <span class="red-color font-weight-bold">*</span></label>
                                <input type="text" value="<?php echo e(old('reportRate_usd')); ?>" id="reportRate_usd" name="reportRate_usd" class="form-control rounded"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="hearAboutAstroguru">Where did you hear about <?php echo e(ucfirst($appname)); ?>?</label>
                    ...
                    <div id="step3"
                        ...
                        <h2 class="py-3 text-center"><small class="font-weight-bold"><?php echo e(ucfirst($professionTitle)); ?> Sign Up - Other details</small>
                        </h2>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="whyOnBoard">Why do you think we should onboard you?<span
                                        class="red-color font-weight-bold">*</span></label>
                                <input type="text" id="awhyOnBoard" name="whyOnBoard" value="<?php echo e(old('whyOnBoard')); ?>" class="form-control rounded"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="interviewSuitableTime">What is suitable time for interview?<span
                                        class="red-color font-weight-bold">*</span></label>
                                <input type="time" value="<?php echo e(old('interviewSuitableTime')); ?>" id="interviewSuitableTime" name="interviewSuitableTime" class="form-control rounded" required>
                            </div>
                            <div class="col-md-6 mb-3">
                    ...
                    <div id="step4"
                        ...
                        <h2 class="py-3 text-center"><small class="font-weight-bold"><?php echo e(ucfirst($professionTitle)); ?> Sign Up - Step 4</small>
                        </h2>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea id="loginBio" name="loginBio" class="form-control rounded" oninput="countWords()" required><?php echo e(old('loginBio')); ?> </textarea>
                                <small id="wordCount">0 words</small>

                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="goodQuality">What are some good qualities of perfect <?php echo e($professionTitle); ?>?</label>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea id="biggestChallenge" name="biggestChallenge" class="form-control rounded" required><?php echo e(old('biggestChallenge')); ?></textarea>
                            </div>
                    ...
                    <div id="step5"
                        class="categorycontent step-4 sychics-join-form position-relative border px-4 pb-4 step">
                        <h2 class="py-3 text-center"><small class="font-weight-bold"><?php echo e(ucfirst($professionTitle)); ?> Sign Up - Bank Details</small>
                        </h2>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="ifscCode">IFSC Code<span
                                        class="red-color font-weight-bold">*</span></label>
                                <input type="text" value="<?php echo e(old('ifscCode')); ?>" id="ifscCode" name="ifscCode"
                                    class="form-control rounded" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="bankName">Bank Name<span
                                        class="red-color font-weight-bold">*</span></label>
                                <input type="text" value="<?php echo e(old('bankName')); ?>" id="bankName" name="bankName"
                                    class="form-control rounded" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="bankBranch">Bank Branch<span
                                        class="red-color font-weight-bold">*</span></label>
                                <input type="text" value="<?php echo e(old('bankBranch')); ?>" id="bankBranch" name="bankBranch"
                                    class="form-control rounded" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="accountNumber">Bank Account No<span
                                        class="red-color font-weight-bold">*</span></label>
                                <input type="text" value="<?php echo e(old('accountNumber')); ?>" id="accountNumber" name="accountNumber"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" value="<?php echo e(old('confirmAccountNumber')); ?>" id="confirmAccountNumber" name="confirmAccountNumber"
                                    class="form-control rounded" oninput="enforceMaxLength(this, 20)">
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="accountHolderName">Account holder Name<span class="red-color font-weight-bold">*</span></label>
                                <input type="text" value="<?php echo e(old('accountHolderName')); ?>" id="accountHolderName" name="accountHolderName"
                                    class="form-control rounded" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="upi">Upi Id</label>
                                <input type="text" value="<?php echo e(old('upi')); ?>" id="upi" name="upi"
                                    class="form-control rounded">
                            </div>
                    ...
                    <div id="step6"
                        class="categorycontent step-4 sychics-join-form position-relative border px-4 pb-4 step">
                        <h2 class="py-3 text-center"><small class="font-weight-bold"><?php echo e(ucfirst($professionTitle)); ?> Sign Up - Step 5</small>
                        </h2>
                        <div class="row">
                            <div class="col-12 mb-3">
            ...
            <div class="col-lg-6 sychics-join-info pt-lg-0 pt-5">
                <h2><small class="font-weight-bold">BECOME "<?php echo e(strtoupper($appname)); ?> VERIFIED" <?php echo e(ucwords($professionTitle)); ?>: <b
                            class="red-color font-weight-bold">JOIN NOW!</b></small></h2>
                <p>
                    <?php echo e(ucfirst($appname)); ?>, one of the best online astrology portals gives you a chance to be a part of its community
                    of best and top-notch <?php echo e(ucfirst($professionTitle)); ?>s. Become a part of the team of <?php echo e(ucfirst($professionTitle)); ?>s and offer your
                ...
                <div class="row py-2">
                    <div class="col-sm-4 col-12 mb-sm-0 mb-3">
                        <div class="border border-danger rounded text-center p-3 h-100">
                            ...
                            <p class="mb-0"><?php echo e(ucfirst($professionTitle)); ?>s</p>
                        </div>
                    </div>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/frontend/astrologers/pages/astrologers-registration.blade.php ENDPATH**/ ?>