...
<?php $__env->startSection('subcontent'); ?>
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"><?php echo e(ucfirst($professionTitle)); ?> Details</h2>
    </div>
    <!-- BEGIN: Profile Info -->
                ...
                <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                    <div class="w-20 h-20 sm:w-24 sm:h-24 flex-none lg:w-32 lg:h-32 image-fit relative">
                        ...
                        <img class="rounded-full"
                                     src="<?php echo e(Str::startsWith($astrologerDetail->profileImage, ['http://','https://']) ? $astrologerDetail->profileImage : '/' . $astrologerDetail->profileImage); ?>"
                                     onerror="this.onerror=null;this.src='/build/assets/images/person.png';"
                                     alt="Customer profileImage"
                                     onclick="openImage('<?php echo e($astrologerDetail->profileImage); ?>')" />
                        <?php else: ?>
                            <img class="rounded-full"
                                     src="<?php echo e(Str::startsWith($astrologerDetail->profileImage, ['http://','https://']) ? $astrologerDetail->profileImage : '/' . $astrologerDetail->profileImage); ?>"
                                     onerror="this.onerror=null;this.src='/build/assets/images/person.png';"
                    ...
                    <div class="ml-5">
                        ...
                        <div class="text-slate-500">
                            <?php echo e(@$astrologerDetail->countryCode ? @$astrologerDetail->countryCode : '--'); ?> <?php echo e($astrologerDetail->contactNo ? $astrologerDetail->contactNo : '--'); ?></div>
                    </div>
                </div>
                <div
                    ...
                    <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                        ...
                        <div class="truncate sm:whitespace-normal flex items-center mt-1">
                          ...
                          <path d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.9 7.9 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.9 7.9 0 0 0 13.6 2.326zM7.994 14.521a6.6 6.6 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.56 6.56 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592m3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.73.73 0 0 0-.529.247c-.182.198-.691.677-.691 1.654s.71 1.916.81 2.049c.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232"/>
                            ...
                            <?php echo e($astrologerDetail->whatsappNo ? $astrologerDetail->whatsappNo : '--'); ?>

                        </div>

                         <div class="truncate sm:whitespace-normal flex items-center mt-1">
                           Aadhar :
                            <?php echo e($astrologerDetail->aadharNo ? $astrologerDetail->aadharNo : '--'); ?>

                        </div>

                        <div class="truncate sm:whitespace-normal flex items-center mt-1">
                           Pan :
                            <?php echo e($astrologerDetail->pancardNo ? $astrologerDetail->pancardNo : '--'); ?>
                    ...
                    <div class="flex items-center justify-center lg:justify-start mt-2">
                        <div class="flex">
                            ...
                            <span class="ml-3 font-medium text-success">
                                <?php echo e($astrologerDetail->totalOrder ? $astrologerDetail->totalOrder : '--'); ?> Order
                            </span>
                            <!-- Edit Button -->
                            <button class="ml-4 px-2 py-1 text-sm bg-blue-500  rounded btn btn-danger" onclick="document.getElementById('editModal').style.display='block'">
                                ...
                                <div id="editModal" class="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 flex justify-center items-center" style="display:none;">
                                    <div class="bg-white p-5 rounded-lg">
                                        ...
                                        <form action="<?php echo e(route('editTotalOrder')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <div class="mb-4">
                                                <label for="totalOrder" class="block font-medium">Total Order:</label>
                                                <input type="number" id="totalOrder" name="totalOrder" class="border border-gray-300 p-2 rounded w-full" value="<?php echo e($astrologerDetail->totalOrder); ?>">
                                                 <input type="hidden" id="astroId" name="id" value="<?php echo e($astrologerDetail->id); ?>">
                                            </div>
            ...
            <div id="link-tab" class="p-3">
                ...
                <div class="tab-content astrologer-tab-content mt-5">
                                ...
                                <div class="grid grid-cols-12 gap-6">
                                    <div class="col-span-12 md:col-span-6">
                                        <div class="intro-y box p-5 mt-12 sm:mt-5" style="height:100%">
                                            ...
                                            <div class="flex items-center mb-5">
                                                <div class="flex items-center">
                                                    <div><?php echo e(ucfirst($professionTitle)); ?> Category</div>
                                            ...
                                            <div class="flex items-center mb-5">
                                                <div class="flex items-center">
                                                    <div>Where did you hear about <?php echo e(ucfirst($appname)); ?></div>
                                                </div>
                                                <div class="ml-auto">
                                    ...
                                    <div class="col-span-12 md:col-span-6 ">
                                        <div class="intro-y box p-5 mt-12 sm:mt-5" style="height:100%">
                                            ...
                                            <div class="flex items-center mb-5">
                                                <div>Login Bio</div>
                                                <div class="ml-auto"><?php echo e($astrologerDetail->loginBio); ?></div>
                                            </div>
                                            <div class="flex items-center mb-5">
                                    ...
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 flex items-center">
                                            <div class="ml-4 mr-auto">
                                                ...
                                                <?php if($wallet->transactionType != 'Gift' && $wallet->transactionType != 'ProductRefCommission' && $wallet->transactionType != 'courseOrder'): ?>
                                                    <?php echo e($wallet->transactionType); ?> with <?php echo e($wallet->name); ?> for <?php echo e($wallet->totalMin); ?> minutes
                                                <?php elseif($wallet->transactionType == 'ProductRefCommission'): ?>
                                                    Received Product Commission Referred to <?php echo e($wallet->productRefName ?? 'User'); ?>

                                                <?php elseif($wallet->transactionType == 'courseOrder'): ?>
                                                        Course Purchased
                                                <?php else: ?>
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div
                                                    class="ml-4 mr-2 <?php echo e($wallet->transactionType == 'courseOrder' ? 'text-danger' : 'text-success'); ?>">
                                                    <div class="font-medium">
                                                        <?php if($wallet->transactionType == 'courseOrder'): ?> (-) <?php else: ?> <span>(+)</span> <?php endif; ?>  <?php echo e($currency->value); ?><?php echo e($wallet->amount); ?></div>
                                                </div>
                                            ...
                                            <div class="p-5">
                                                <div class="image-fit" style="height:150px;width:150px">
                                                    <img class="rounded-full" style="width: 100%; height: 100%;"
                                                        ...
                                                        onerror="this.onerror=null;this.src='/build/assets/images/person.png';"
                                                        alt="<?php echo e($professionTitle); ?> image" />
                                                </div>
                                                <div class="font-medium text-center lg:text-left lg:mt-3">
                                                    <?php echo e($chatHistory->name); ?></div>
                                                <div class="text-slate-600 dark:text-slate-500 mt-2">
                                                    <div class="flex items-center">
                                                        <?php echo e(date('d-m-Y h:i a', strtotime($chatHistory->created_at))); ?>
                                    ...
                                    <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3">
                                        <div class="box">
                                            <div class="p-5">
                                                ...
                                                <div class="text-slate-600 dark:text-slate-500 mt-2">
                                                    <div class="flex items-center">
                                                        <?php echo e(date('d-m-Y h:i a', strtotime($callHistory->created_at))); ?>
                    ...
                    <div id="example-tab-11" class="tab-pane leading-relaxed" role="tabpanel"
                        ...
                        <div class="col-span-12 xl:col-span-4 mt-6">
                            <div class="mt-5">
                                <?php if(count($astrologerDetail->pujaorders) > 0): ?>
                                    <?php $__currentLoopData = $astrologerDetail->pujaorders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="intro-y">
                                            <div class="box px-4 py-4 mb-3 flex items-center">
                                                <div class="ml-4 mr-auto">
                                                    <div class="font-medium text-success">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(!empty($astrologerDetail->$inputName)): ?>
                                <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3">
                                    <div class="box">
                                        <div class="p-5">
                                            <div class="h-20 2xl:h-56 image-fit" style="height:150px;width:150px">
                                                <img class="class="rounded-full"
                                     src="<?php echo e(Str::startsWith($astrologerDetail->$inputName, ['http://','https://']) ? $astrologerDetail->$inputName : '/' . $astrologerDetail->$inputName); ?>"
                                     onerror="this.onerror=null;this.src='/build/assets/images/person.png';"
                                     alt="Customer $inputName"
                                     onclick="openImage('<?php echo e($astrologerDetail->$inputName); ?>')" />
                                            </div>
                                            <div class="text-center mt-2"><?php echo e(ucfirst(str_replace('_', ' ', $document->name))); ?></div>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="intro-y box p-5" style="height:100%">
                            ...
                            <div class="flex items-center mb-5">
                                ...
                                <div class="ml-auto"><?php echo e($astrologerDetail->ifscCode); ?></div>
                            </div>
                            <div class="flex items-center mb-5">
                                <div class="flex items-center">
                                    <div>Bank Name</div>
                                ...
                                <div class="ml-auto">
                                    <?php echo e($astrologerDetail->bankName); ?>
                             ...
                             <div class="flex items-center mb-5">
                                ...
                                <div class="ml-auto">
                                    <?php echo e($astrologerDetail->bankBranch); ?>
                            ...
                            <div class="flex items-center mb-5">
                                ...
                                <div class="ml-auto">
                                    <?php echo e($astrologerDetail->accountType); ?>
                             ...
                             <div class="flex items-center mb-5">
                                ...
                                <div class="ml-auto">
                                    <?php echo e($astrologerDetail->accountNumber); ?>
                             ...
                             <div class="flex items-center mb-5">
                                ...
                                <div class="ml-auto">
                                    <?php echo e($astrologerDetail->upi); ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/happylifevastu/public_html/resources/views/pages/astrologer-detail.blade.php ENDPATH**/ ?>